...
namespace BoardGameShopMVC.DAL
{
    public class StoreInitializer : MigrateDatabaseToLatestVersion<StoreContext, Configuration>
    {
        ...
        public static void SeedStoreData(StoreContext context)
        {
            ...
            {
                new Game() { GameID = 1, DesignerName = "Antoine Bauza", GameTitle = "7 Wonders", Price = 129.99M, GameFileName = "7wonders.png", IsBestseller = false, DateAdded = new DateTime(2018, 03, 05), CategoryId = 9},
                ...
                new Game() { GameID = 6, DesignerName = "Nikki Valens", GameTitle = "Mansions of Madness", Price = 359.99M, GameFileName = "mansionsOfMadness.png", IsBestseller = false, DateAdded = new DateTime(2017, 01, 01), CategoryId = 3},
                ...
                new Game() { GameID = 8, DesignerName = "Philippe Keyaerts", GameTitle = "Smallwordl", Price = 149.99M, GameFileName = "smallworld.png", IsBestseller = true, DateAdded = new DateTime(2018, 03, 03), CategoryId = 9},
                new Game() { GameID = 9, DesignerName = "Colby Dauch", GameTitle = "Summoner Wars", Price = 159.99M , GameFileName = "summonerWars.png", IsBestseller = false, DateAdded = new DateTime(2018, 03, 01), CategoryId = 5}
            };
