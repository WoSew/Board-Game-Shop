        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal(returnUrl); // RedirectToLocal, not RedirectToAction because we want to miss hackers attacts from referal links
                ...
                default:
                    ModelState.AddModelError("loginerror", "Nieudana próba logowania."); //goes to Login.cshtml 
                    return View(model);
            }
        }

        public ActionResult RedirectToLocal(string returnUrl) //check if url is local
        {
